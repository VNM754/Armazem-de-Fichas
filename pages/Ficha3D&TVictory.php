<?php
    ...
    foreach ($atributos as $atributo) {
        if ($atributo['nome'] == 'RES') {
            $modificadorVida = $atributo['valor'];
            break;
        }
    }
        ...
        <form action="<?= "AtualizarFicha.php?id_ficha= " . $fichaId?>" class="ficha__T20" method="post">
            ...
            <section class="ficha-T20-cabecalho">
                <section class="ficha-T20-cabecalho-textboxes">
                    ...
                    <label class="ficha-T20-cabecalho-label">Kits:</label>
                    <div>
                        <?php foreach ($classesDaFicha as $classe) :?>
                            ...
                            <input class="ficha-T20-cabecalho-textbox ficha-t20-classes-nivel" type="number" name="niveis[]" min="1" value="<?= $classe['nivel']?>">
